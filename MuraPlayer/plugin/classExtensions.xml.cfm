...
<cfsavecontent variable="commonPlayerAttributes">
	...
	<attribute
		name="muraPlayerControlbarDisplay"
		label="Display Control Bar"
		hint="Turns on or off the control bar"
		type="SelectBox"
		defaultValue="true"
		required="false"
		validation="None"
	...
	<attribute
		...
		label="Repeat"
		hint="What to do when the mediafile has ended. Either repeat the clip, or stop."
		type="SelectBox"
		defaultValue="none"
		required="false"
		validation="None"
	...
	<extensions>
		...
		<extension type="Page" subType="MuraPlayer" hasBody="1">
			...
			<attributeset name="MuraPlayer Options" container="Basic">
				...
				<attribute 
					name="muraPlayerHostedURL"
					label="Hosted video URL (Don't use if uploading a Media File)"
					hint="The full, complete URL of the hosted video, used when your video is placed on a media streaming host, for example."
					type="Text"
					defaultValue=""
					required="false"
					validation="None"
				...
				<attribute 
					...
					optionLableList="" />
				<attribute 
					name="muraPlayerPlaceholder"
					label="Placeholder image"
					hint="This is displayed before the video starts playing, and should be 516x360px"
					type="File"
					defaultValue=""
					required="false"
					validation="None"
